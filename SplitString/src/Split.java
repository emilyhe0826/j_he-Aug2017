...
public class Split {
	public static void main(String[] args) {
		// testing Example1:
		String test = new String ("I like apples!");
		String[] array = test.split(" ");
		System.out.println(Arrays.toString(array));
		// testing Example2:
		String test2 = new String ("I really like really red apples");
		String[] array2 = test2.split("really");
		System.out.println(Arrays.toString(array2));
		
		// task1:
		task1("applespineapplesbreadlettucestomatobaconmayohambreadcheese");
		task1("breadlettucestomatobaconmayohambread");
		task1("applesbreadtomatobreadcheese");
		task1("breadbreadbread");
		task2("breadcheesebreadcheesebread");
		task1("breadbread");
		task1("bread");
		...
		task2("bread cheese bread cheese bread");
		task2("breadbread");
		task2("bread");
